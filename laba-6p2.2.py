...
# целевая функция - минимизация калорийности
...
filtered_combinations = sorted(filtered_combinations, key=calorie_count)

# вывод результата
count = len(filtered_combinations)
for i, combination in enumerate(filtered_combinations):
    print("Вариант №", i+1, "- калорийность:", calorie_count(combination))
